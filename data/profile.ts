...
export const aboutParagraphs: string[] = [
  ...
  'At Hub Group, I have worked across large modernization programs involving Kubernetes-based Node.js microservices, Azure Service Bus-driven recovery workflows, ETL integrations, Redis-backed caching, MongoDB performance tuning, anomaly detection, and CI/CD automation. The work has contributed to measurable outcomes including lower latency, reduced manual intervention, faster release cycles, and major cost savings.',
...
export const skillsByCategory = {
  ...
  Cloud: ['Microsoft Azure', 'AWS', 'Kubernetes', 'Docker', 'CI/CD Pipelines', 'Jenkins', 'GitHub Actions', 'Terraform', 'Container Orchestration'],
